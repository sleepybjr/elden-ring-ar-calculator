...
const Weapon_Damage = require('../src/json/weapon_damage');
const Weapon_Scaling = require('../src/json/weapon_scaling');
const Calc_Correct_Id = require('../src/json/calc_correct_id');
const Weapon_Passive = require('../src/json/weapon_passive');
...
var fs = require('fs');
fs.writeFile("../src/json/merged_json_data.json", string_data, function(err) {
    if (err) {
        console.log(err);
    }
});